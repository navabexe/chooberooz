...
from src.shared.errors.base import TooManyRequestsException, BadRequestException, UnauthorizedException, ForbiddenException
...
async def call_complete_profile_service(
    ...
    try:
    ...
    except (BadRequestException, UnauthorizedException, ForbiddenException, TooManyRequestsException) as e:
        log_error(f"Profile completion failed: {e.detail}", extra={
            "error": str(e),
            "client_ip": client_ip,
            "request_id": data.request_id
        })
        ...
        log_error("Unexpected error during profile completion", extra={
            "error": str(e),
            "client_ip": client_ip,
            "request_id": data.request_id
        })
...
async def complete_user_profile(
    ...
    try:
        ...
        log_error("Unexpected error in complete_user_profile", extra={
            "error": str(e),
            "client_ip": client_ip,
            "request_id": data.request_id
        })
...
async def complete_vendor_profile(
    ...
    try:
        ...
        log_error("Unexpected error in complete_vendor_profile", extra={
            "error": str(e),
            "client_ip": client_ip,
            "request_id": data.request_id
        })
